(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('database', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/database/databases.html',
        ...
        .state('database-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/database/database-detail.html',
        ...
        .state('database-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/database/database-dialog.html',
        ...
        .state('database.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/database/database-delete-dialog.html',
