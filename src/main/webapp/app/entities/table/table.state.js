(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('table', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/table/tables.html',
        ...
        .state('table-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/table/table-detail.html',
        ...
        .state('table-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/table/table-dialog.html',
        ...
        .state('table.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/table/table-delete-dialog.html',
