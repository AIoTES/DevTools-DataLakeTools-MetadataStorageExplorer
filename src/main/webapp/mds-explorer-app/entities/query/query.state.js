(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('query', {
            ...
            views: {
                'content@': {
                    templateUrl: 'mds-explorer-app/entities/query/queries.html',
        ...
        .state('query-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'mds-explorer-app/entities/query/query-detail.html',
        ...
        .state('query-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'mds-explorer-app/entities/query/query-dialog.html',
        ...
        .state('query.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'mds-explorer-app/entities/query/query-delete-dialog.html',
