(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('model', {
            ...
            views: {
                'content@': {
                    templateUrl: 'metadata-explorer-app/entities/device/models.html',
        ...
        .state('model-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'metadata-explorer-app/entities/device/model-detail.html',
        ...
        .state('model-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'metadata-explorer-app/entities/device/model-dialog.html',
        ...
        .state('model.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'metadata-explorer-app/entities/device/model-delete-dialog.html',
