(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('schema', {
            ...
            views: {
                'content@': {
                    templateUrl: 'dm-explorer-app/entities/schema/schemata.html',
        ...
        .state('schema-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'dm-explorer-app/entities/schema/schema-detail.html',
        ...
        .state('schema-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'dm-explorer-app/entities/schema/schema-dialog.html',
        ...
        .state('schema.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'dm-explorer-app/entities/schema/schema-delete-dialog.html',
