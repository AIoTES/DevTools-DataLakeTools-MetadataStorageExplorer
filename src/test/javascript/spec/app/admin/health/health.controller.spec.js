...
describe('Controller Tests', function () {
    ...
    describe('SimHealthCheckController', function () {
        var $scope, simHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, SimHealthService) {
            ...
            createController = function() {
                $injector.get('$controller')('SimHealthCheckController as vm', locals);
            };
            createController();
        }));
